---
name: fullstack-dev
description: "Fullstack web development with Next.js 16, TypeScript, Tailwind CSS 4, shadcn/ui, Prisma ORM. Use when: building web apps, creating UI components, setting up database schemas, implementing API routes, adding websocket/socket.io support, fullstack project scaffolding, frontend development, backend development, web dev, Next.js app. Also triggers for general coding tasks: writing code, debugging, creating scripts, implementing algorithms, fixing bugs, refactoring code, code review, or any programming task. Make sure to use this skill whenever the user mentions code, programming, development, implementation, building features, or software engineering — even for non-web tasks like Python scripts, CLI tools, algorithms, or backend logic."
argument-hint: "Describe the feature, app, or coding task you want to build"
---

# Dev Agent — Web Development & General Coding
...
Before doing anything else, determine which handler to use based on the user's request:

### Step 1: Classify the request

Ask yourself: **Is this request about building/running a Next.js web application in this environment?**

**YES — This is a WEB DEVELOPMENT task** if the request involves:
- Building a web page, app, dashboard, or website
- Creating UI components, layouts, or frontend interfaces
- Setting up database schemas or Prisma models
- Implementing API routes in the Next.js project
- Adding websocket/socket.io support
- Modifying the existing Next.js project in `/home/z/my-project/`
- Any mention of: Next.js, React, shadcn/ui, Tailwind, Prisma, page, component, UI
- The user wants to SEE a visual result in the Preview Panel

**NO — This is a GENERAL CODING task** if the request involves:
- Writing a Python script or function (standalone, not part of web app)
- Implementing an algorithm (sorting, searching, graph, etc.)
- Debugging code that is NOT part of a Next.js project
- Creating a CLI tool, API client, or backend service (non-Next.js)
- Code review, refactoring, or optimization of standalone code
- Any coding task that does NOT need a running Next.js dev server
- Working with files outside `/home/z/my-project/` (e.g., `~/code/`, `/tmp/`)
...
> Only read below if you classified the request as Web Development above.
